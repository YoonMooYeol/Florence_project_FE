  ...
  <div class="flex flex-col items-center justify-center min-h-screen p-4 bg-ivory">
    <div class="w-full max-w-md">
      ...
      <div class="mb-8 text-center">
        ...
        <p class="mt-2 text-dark-gray">로그인</p>
      </div>
        ...
        <div class="flex flex-col space-y-3">
          ...
          <div class="mt-6 mb-4">
            ...
            <div class="flex flex-col space-y-3">
              ...
              >
                <svg class="w-5 h-5 mr-3" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 3C6.48 3 2 6.48 2 11c0 2.95 1.83 5.52 4.53 6.97V21l4.13-2.48c.43.05.86.08 1.34.08 5.52 0 10-3.48 10-8s-4.48-8-10-8z" fill="#3A1D1D"/>
                </svg>
              ...
              >
                <svg class="w-5 h-5 mr-3" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16 8.8V15h-2.6L11 11.5V15H8V8.8h2.5l2.5 3.5V8.8H16z" fill="white"/>
                </svg>
              ...
              >
                <svg class="w-5 h-5 mr-3" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M17.05 20.28c-.98.95-2.05.88-3.08.45-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.47C2.7 15.25 3.78 7.46 9.02 7.18c1.59-.08 2.58.73 3.56.78 1.37-.21 2.44-1.05 3.82-.84 1.63.25 2.83 1.19 3.41 2.77-3.4 2.11-2.2 6.89.93 8.35-.7 1.43-1.47 2.87-3.69 2.04zm-5.35-14.6c-.12-2.13 1.99-4.04 3.98-4.2.29 2.47-2.38 4.32-3.98 4.2z" fill="white"/>
                </svg>
